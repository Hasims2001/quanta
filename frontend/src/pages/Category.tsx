...
export const Category = () => {
  return (
    <div className="bg-[#F3F4F6] text-black">
      <div className="max-w-7xl m-auto pl-10">
        <div className="flex gap-20 justify-between">
          <div className="flex flex-col gap-10 pt-20 pb-20">
            <div className="bg-white border border-2 border-blue-400 w-[500px] p-5 rounded-xl transform hover:scale-105 transition-transform duration-300 hover:shadow-xl">
                ...
                <hr />
                <button className="p-3 rounded-xl bg-blue-500 text-white hover:bg-blue-600 hover:text-white mt-3">Start the Interview</button>
            </div>
          ...
          <img src="https://img.freepik.com/free-photo/side-view-woman-working-indoors_23-2149915936.jpg?size=626&ext=jpg&ga=GA1.1.1257944628.1683352118&semt=ais" width={"630px"} alt="" />
        </div>
      </div>
    </div>
  )
