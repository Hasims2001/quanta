...
export const Home = () => {
  ...
  return (
    <div className="bg-[#0A2640] text-white">
      <div className="p-10 m-auto flex justify-evenly gap-10 pt-20 pb-20 max-[768px]:flex-col ">
        ...
        <img src="https://img.freepik.com/premium-photo/ai-generated-illustrution-robot-is-interviewing-man-modern-office_441362-10368.jpg?size=626&ext=jpg&ga=GA1.1.1257944628.1683352118&semt=ais" alt="welcome" style={{width:"700px", height:"500px"}} className="object-cover shadow-lg shadow-blue-500 rounded-xl" />
      </div>
    </div>
  )
}
